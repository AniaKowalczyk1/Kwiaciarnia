...
public class CutFlowers extends Kwiatek {

    private String odmiana; 

    public CutFlowers(int id, String typ, String rod, String odm, String kol, int iloscZ, double cenaZ, LocalDate dataZ,
    ...
    public List<String[]> fCzytaj() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("kwiaty_ciete_baza.txt"))) {
            String line;
            while ((line = br.readLine()) != null) {
                ...
                flowerData[3] = br.readLine(); // Odmiana
    ...
    @Override
    public void fDodaj() {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("kwiaty_ciete_baza.txt", true))) {
            bw.write(id + "\n" +
                    typ + "\n" +
                    rodzaj + "\n" +
                    odmiana + "\n" +
    ...
    public void fDodajPoId(int idToAddAfter, Kwiatek kwiatek) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("kwiaty_ciete_baza.txt"))) {
